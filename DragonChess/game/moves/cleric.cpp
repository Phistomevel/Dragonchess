...
namespace game {
    namespace moves {
        ...
        Cleric::Cleric() {}
        Cleric::~Cleric() {}
        std::vector<::game::Moves> Cleric::getMoves(::game::Board board, ::game::pieces::Abstract& ActivePiece) {
        ...
        std::vector<::game::moves::Capture> Cleric::getCaptures(::game::Board board, ::game::pieces::Abstract& ActivePiece) {
