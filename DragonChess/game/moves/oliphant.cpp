...
namespace game {
    namespace moves {
        ...
        Oliphant::Oliphant() {}
        Oliphant::~Oliphant() {}
        std::vector<::game::Moves> Oliphant::getMoves(::game::Board board, ::game::pieces::Abstract& ActivePiece) {
        ...
        std::vector<::game::moves::Capture> Oliphant::getCaptures(::game::Board board, ::game::pieces::Abstract& ActivePiece) {
