...
namespace game {
    namespace moves {
        ...
        Basilisk::Basilisk() {}
        Basilisk::~Basilisk() {}
        std::vector<::game::Moves> Basilisk::getMoves(::game::Board board, ::game::pieces::Abstract& ActivePiece) {
        ...
        std::vector<::game::moves::Capture> Basilisk::getCaptures(::game::Board board, ::game::pieces::Abstract& ActivePiece) {
